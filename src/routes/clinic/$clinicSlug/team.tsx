...
const getClinicTeamData = createServerFn({ method: 'GET' })
  ...
  .handler(
    async ({
      ...
      const { generateTeamPage } = await import('@/server/website-generator')
      ...
      const pageData = generateTeamPage(context as any, 'en')
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div
          ...
          dangerouslySetInnerHTML={{
            __html: teamData.html.replace(/href="\/([^"]*)"/, `href="/clinic/${clinicSlug}/$1"`),
          }}
        />
      </main>
