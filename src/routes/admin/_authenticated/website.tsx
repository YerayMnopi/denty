        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              <Button variant="outline" onClick={handlePreview} disabled={!website}>
                👁️ Preview Website
              </Button>
              <Button onClick={handleSave} disabled={!website || isSaving}>
        ...
        {!website ? (
          <div className="text-center py-12 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-600 mb-6">
              You don't have a website set up yet. Create one to start building your online
              presence.
            </p>
            <Button
              onClick={() => {
                /* Navigate to create website */
              }}
            >
              Create Website
            </Button>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-600">
                        Choose which pages to include on your website. Disabled pages won't be
                        ...
                        >
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              ...
                              {pageKey === 'services' &&
                                'Detailed list of all your dental services'}
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="mt-1 text-sm text-yellow-700">
                              The homepage cannot be disabled as it's the main entry point for your
                              website. Disabled pages will return a 404 error when accessed.
                            </p>
                          </div>
                        </div>
                      </div>
                              ...
                              onChange={(e) =>
                                setFormData((prev) => ({
                                  ...
                                  settings: {
                                    ...
                                    seo: {
                                      ...prev.settings?.seo,
                                      title: { ...prev.settings?.seo?.title, en: e.target.value },
                                    },
                                  },
                                }))
                              }
                              ...
                              onChange={(e) =>
                                setFormData((prev) => ({
                                  ...
                                  settings: {
                                    ...
                                    seo: {
                                      ...prev.settings?.seo,
                                      title: { ...prev.settings?.seo?.title, es: e.target.value },
                                    },
                                  },
                                }))
                              }
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            />
                            <p className="text-xs text-gray-500 mt-1">
                              {(formData.settings?.seo?.description?.en || '').length}/160
                              characters
                            </p>
                          </div>
                          <div>
                            ...
                            />
                            <p className="text-xs text-gray-500 mt-1">
                              {(formData.settings?.seo?.description?.es || '').length}/160
                              characters
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 text-center">
                        ...
                        <p className="text-gray-600 mb-4">
                          Blog functionality will be available here. You'll be able to create, edit,
